...
​	Input Method Engine 与 Input Method Editor，溯源与比较 #todo
...
| Android        | 中文输入法                                                   | trime    | (librime版本1.5.3且不再跟进，仅有某一旧版本源码) |
...
| 影子输入法         | Windows                 | Gitee丨群文件                                               | AHK(v1)  | [开源](https://gitee.com/orz707/Yzime)  |免安装|
