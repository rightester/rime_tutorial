...
（你可能觉得奇怪，这里怎么这么多 `fcitx-`blabla 的东西——我们下面一点就会谈到。）
...
国内还有许多其他非大厂（搜狗百度迅飞手心）的输入法平台，将现在所知和可查的列在下表；我将Rime也置入下表并放在第一行以作对比：

| 输入法平台名称                                               | 支持的操作系统平台      | 下载                                                         | 技术栈   | 是否开源                                             | 部分特色     |
| ------------------------------------------------------------ | ----------------------- | ------------------------------------------------------------ | -------- | ---------------------------------------------------- | ------------ |
| <Rime各发行版>                                               | 几乎所有主流平台        | 官网、群文件、GitHub发布页                                   | C++等    | 多数完全开源                                         | 高度可定制   |
| [小胖输入法](https://pangime.com/)                           | Windows、Android        | 群文件、度盘、[永硕盘](http://pangime.ysepan.com/)           | C#       | 否                                                   | 双检索       |
| [小小输入法](http://yong.dgod.net/)                          | Windows、Android、Linux | 群文件、[永硕盘](http://yongim.ysepan.com/)                  | C++/QT   | 否                                                   | 响应敏捷     |
...
| [影子输入法](https://www.autoahk.com/archives/15117)         | Windows                 | 群文件                                                       | AHK(v1)  | [源码可见](https://github.com/Gental-King/-)         | 免安装       |
| [多多输入法生成器](https://www.duo.ink/ddimegen/ddimegen-desc.html) | Windows                 | 官网                                                         | C        | 否                                                   | 易于打包     |
| [冰凌输入法](https://www.icesofts.com/)<br/>(继承自影子)     | Windows                 | 官网                                                         |          | 否                                                   | 轻简         |
| 燕子输入法                                                   | Windows                 | [GitHub仓库](https://github.com/beishanyufu/Yanzi-IME)直取项目源码 | AHK(v1)  | [开源](https://github.com/beishanyufu/Yanzi-IME)     | 免安装       |
| [启程输入法](http://soime.cn/)                               | Windows                 | 官网                                                         | C++/SOUI | [仅部分开源](https://github.com/soui4-demo/sinstar3) |              |

这些多样的输入法平台，它们各有各优点和长处。对于其中的闪光点，我们无须吝啬自己的称赞，而不必互相之间拉踩。

在你见识过许多输入法平台后应该也会发现，Rime并非完美无缺。当你感到Rime不适合自己时，不妨去探索下其他输入法平台。
